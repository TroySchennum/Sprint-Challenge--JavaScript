...
const tyrannosaurus =
{
  "diet": "carnivorous", "weight": "7000kg", "length": "12m", "period": "Late Cretaceous", roar: function () {
...
const stegosaurus =
  { "diet": "herbivorous", "weight": "2000kg", "length": "9m", "period": "Late Jurassic", }
  ;
// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
const velociraptor = {
  diet: "carnivorous", weight: "15kg", length: "1.8m", period: "Late Cretaceous",
};
...
const unisWithUni = graduates.filter(item => {
  if (item.university.includes(`Uni`) === true) {
